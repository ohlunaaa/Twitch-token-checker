...
ziro =  Fore.LIGHTCYAN_EX + " [" + Fore.RESET + "Z" + Fore.LIGHTCYAN_EX + "] " + Fore.RESET
...
def start(): 
    ...
    def title():
        ...
        while True:
            ...
            sep = "."
            stripped = timex.split(sep, 1)[0]
            os.system(f"title  ZiroChecker v3")
            ...
            def print_stats():
                ...
                print()
                print(ziro +    f" TIME: {stripped}")
                print(ziro +    f" LEFT: {str(Data.left)}")
            print_stats()
            time.sleep(1)
            cls()
